...
for scalar_test in scalar roundtrip streaming huffman ans api_contract exact_buffer_decode entropy_workspace fast_workspace xxh64; do
...
printf 'scalar gate PASS: general-register core, ten test suites\n'
