...
Release v2.61.1 (tag `v2.61.1`). GPL-3.0-or-later.
...
gh release create v2.61.1 \
  ...
  --title "VaptVupt v2.61.1" \
  --notes-file RELEASE_v2.61.1.md
```
...
# portfile.cmake: REF v2.61.1, SHA512 <above>
```
...
| File | Purpose |
|---|---|
| `vaptvupt-2.61.1-src.tar.gz` | Source (`git archive v2.61.1`) |
...
| `CHANGELOG.md`, `COMPARISON.md`, `RELEASE_v2.61.1.md` | Docs |
