...
Release v2.65.2 (tag `v2.65.2`). GPL-3.0-or-later.
...
gh release create v2.65.2 \
  ...
  --title "VaptVupt v2.65.2" \
  --notes-file <(awk '/^## v2.65.2 /{f=1;next} /^## /{f=0} f' CHANGELOG.md)
```
...
# portfile.cmake: REF v2.65.2, SHA512 <above>
```
...
| File | Purpose |
|---|---|
| `vaptvupt-2.61.1-src.tar.gz` | Source (`git archive v2.65.2`) |
