...
Release v2.63.0 (tag `v2.63.0`). GPL-3.0-or-later.
...
gh release create v2.63.0 \
  ...
  --title "VaptVupt v2.63.0" \
  --notes-file <(awk '/^## v2.63.0 /{f=1;next} /^## /{f=0} f' CHANGELOG.md)
```
...
# portfile.cmake: REF v2.63.0, SHA512 <above>
```
...
| File | Purpose |
|---|---|
| `vaptvupt-2.61.1-src.tar.gz` | Source (`git archive v2.63.0`) |
